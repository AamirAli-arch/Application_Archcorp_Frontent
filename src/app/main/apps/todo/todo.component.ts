...
export class TodoComponent implements OnInit, OnDestroy
{
    ...
    projectSearchInput: FormControl;
    currentTodo: Todo;
    filter: number;
    ...
    ngOnInit(): void
    {
        ...
        this._taskService.onFiltersChanged
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe(folders => {
                this.filters = this._taskService.filters;
            });
        ...
        .subscribe(searchText => {
            this._todoService.onProjectTextChanged.next(searchText);
        })
